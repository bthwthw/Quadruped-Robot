% =========================================================
% SCRIPT VẼ ĐỒ THỊ TỪ FILE CSV DÁNG ĐI BOUND
% =========================================================
...
title('Sai số bám quỹ đạo khớp Háng (Hip Error)', 'FontSize', 13);
...
title('Sai số bám quỹ đạo khớp Gối (Knee Error)', 'FontSize', 13);
...
% (Bạn có thể bỏ qua dòng này nếu dùng phiên bản MATLAB quá cũ, thay bằng màu RGB cụ thể)
% =========================================================
