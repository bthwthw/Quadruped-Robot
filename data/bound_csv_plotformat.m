% =========================================================
% SCRIPT VẼ ĐỒ THỊ TỪ FILE CSV DÁNG ĐI PACE
% =========================================================
...
% =========================================================
figure('Name', 'Đáp ứng vị trí - Pace Gait', 'Color', 'w', 'Units', 'centimeters', 'Position', [2 5 22 16]);
...
title('Đáp ứng quỹ đạo khớp Háng (Hip) - Pace Gait', 'FontSize', 13);
...
title('Đáp ứng quỹ đạo khớp Gối (Knee) - Pace Gait', 'FontSize', 13);
...
% =========================================================
figure('Name', 'Tracking Error - Pace Gait', 'Color', 'w', 'Units', 'centimeters', 'Position', [6 8 22 16]);
...
title('Sai số bám quỹ đạo khớp Háng (Hip Error) - Pace Gait', 'FontSize', 13);
...
title('Sai số bám quỹ đạo khớp Gối (Knee Error) - Pace Gait', 'FontSize', 13);
